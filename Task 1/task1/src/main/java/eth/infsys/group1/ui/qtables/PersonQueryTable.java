...
public abstract class PersonQueryTable<TRPerson>
		extends QueryTable<TRPerson, FxPerson<TRPerson>, FxPerson.QueryOptions> {

	private static class SearchPQT<TRPerson> extends PersonQueryTable<TRPerson> {
		
		private TextField searchText = new TextField();

		public SearchPQT(DBProvider<?, ?, ?, TRPerson, ?, ?, ?, ?> dbProvider) {
			super(dbProvider);
		}
	...
	public static <TRPerson> PersonQueryTable<TRPerson> createTableWithAddRemoveToolBar(
	...
	public static <TRPerson> PersonQueryTable<TRPerson> createTableWithAddRemoveViewToolBar(
			DBProvider<?, ?, ?, TRPerson, ?, ?, ?, ?> dbProvider,
			FxObjEventHandler<FxPerson<TRPerson>> addButtonHandler,
			FxObjEventHandler<FxPerson<TRPerson>> removeButtonHandler,
			FxObjEventHandler<FxPerson<TRPerson>> viewButtonHandler) {
	...
	public static <TRPerson> PersonQueryTable<TRPerson> createTableWithCreateToolBar(
			DBProvider<?, ?, ?, TRPerson, ?, ?, ?, ?> dbProvider) {
	...
	public PersonQueryTable(DBProvider<?, ?, ?, TRPerson, ?, ?, ?, ?> dbProvider) {
